...
class MainComponent extends Component{
  ...
  <Card>
    <Card.Body>
      ...
      <p>
            <Button variant="primary" href="https://www.dropbox.com/s/ufwkk1rxu1a27fk/Software%20Requirements%20Specification%20John%20Kyeremeh.pdf?dl=0" target="_blank">Learn more</Button>
            </p>
    </Card.Body>
    <Card.Footer>
      {/* <small className="text-muted">Last updated 3 mins ago</small> */}
  ...
  <Card>
    <Card.Body>
      ...
      <p>
            <Button variant="primary" href="https://share.vidyard.com/watch/HeSePaCcccj6LR9ZRnoN4X?" target="_blank">Learn more</Button>
            </p>
    </Card.Body>
    <Card.Footer>
      {/* <small className="text-muted">Last updated 3 mins ago</small> */}
